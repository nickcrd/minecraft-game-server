...
public class SetNextGameCommand extends ncCommand {
    @Override
    ...
    public void execute(Player player, String[] args)
    {
        ...
        {
            player.sendMessage(C.main("Arcade", "Usage: §f/setnextgame <gamemode>"));
            return;
        }

        GameManager.Instance.nextGame = Gamemode.valueOf(args[0]);
    }
}
